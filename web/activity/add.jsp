...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form id="newAct" method="post" action="/ActivityManagement?action=add_record">
            ...
            <button type="button" onclick="addRecord()" class="btn btn-success m-b-10 m-l-5">确认</button>
    ...
    <script src="<%=request.getContextPath()%>/js/activity/add.js"></script>
